...
// LOAD YAML
double RES;
double env_x_min, env_x_max, env_y_min, env_y_max, env_z_min, env_z_max;
double DRONE_X, DRONE_Y, DRONE_Z;

void readParams(){
	ros::param::get("/RES", RES);
	ros::param::get("/env_x_min", env_x_min);
	ros::param::get("/env_x_max", env_x_max);
	ros::param::get("/env_y_min", env_y_min);
	ros::param::get("/env_y_max", env_y_max);
	ros::param::get("/env_z_min", env_z_min);
	ros::param::get("/env_z_max", env_z_max);
	ros::param::get("/DRONE_X", DRONE_X);
	ros::param::get("/DRONE_Y", DRONE_Y);
	ros::param::get("/DRONE_Z", DRONE_Z);
}
